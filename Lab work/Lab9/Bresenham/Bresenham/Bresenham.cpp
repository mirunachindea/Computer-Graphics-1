...
int getOctant(BresenhamLine line)
{
	...
	if ((m >= 1) && (deltaX > 0) && (deltaY >= 0)) // seventh octant
		return 7;
	if ((m < 1) && (deltaX > 0) && (deltaY > 0)) // eigth octant
		return 8;
...
void plot_points(int x, int y) {
	...
	SDL_RenderDrawPoint(renderer, x + myCircle.centerX, y + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, x + myCircle.centerX, -y + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, -x + myCircle.centerX, y + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, -x + myCircle.centerX, -y + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, y + myCircle.centerX, x + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, -y + myCircle.centerX, x + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, y + myCircle.centerX, -x + myCircle.centerY);
	SDL_RenderDrawPoint(renderer, -y + myCircle.centerX,-x + myCircle.centerY);
}
